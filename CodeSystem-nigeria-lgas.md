# NG-Imm LGAs in Nigeria CS - PCN ePharmacy Implementation Guide v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **NG-Imm LGAs in Nigeria CS**

## CodeSystem: NG-Imm LGAs in Nigeria CS 

| | |
| :--- | :--- |
| *Official URL*:https://pcn.gov.ng/CodeSystem/nigeria-lgas | *Version*:0.1.0 |
| Active as of 2025-10-13 | *Computable Name*:NGLGAsCS |
...
* [NGLGAsVS](ValueSet-nigeria-lgas.md)
...
```json
{
  ...
  "id" : "nigeria-lgas",
  "url" : "https://pcn.gov.ng/CodeSystem/nigeria-lgas",
  "version" : "0.1.0",
  "name" : "NGLGAsCS",
